...
from operations.operations.report.financial_statement.financial_statements import (get_period_list, get_columns, get_data)

def execute(filters=None):
	period_list = get_period_list(filters.from_fiscal_year, filters.to_fiscal_year,
		filters.periodicity, filters.accumulated_values, filters.company)

	sales_account = frappe.db.get_value("Account", {"company": filters.company, "account_name": "Direct Revenue"}, "name")
	...
	non_operating_account = frappe.db.get_value("Account", {"company": filters.company, "account_name": "Indirect Revenue"}, "name")
